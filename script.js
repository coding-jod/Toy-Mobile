let audio = new Audio("https://www2.cs.uic.edu/~i101/SoundFiles/BabyElephantWalk60.wav");
console.log("hello")
...
document.getElementsByClassName("num1")[0].addEventListener("click", () => {
    audio.pause();
    audio=document.getElementById("n1");
...
//   
  ...
  document.getElementsByClassName("num0")[0].addEventListener("click", () => {
    ...
    audio.play();
    document.querySelector("span").innerHTML=" Single squeak"
  });
